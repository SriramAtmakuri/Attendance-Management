...
window = tk.Tk()
window.title("Intelligent Attendance Solution For MGNREGA Workers")
    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            def create_csv():
                ...
                csv_name='C:/Users/sriramatmakuri/Desktop/New folder (5)/Attendace_management_system-master/Attendance\Manually Attendance'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"C:\Users\sriramatmakuri\Desktop\New folder (5)\Attendace_management_system-master\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def take_img():
    ...
    if l1 == '':
        ...
        try:
            ...
            with open('WorkersDetails\WorkersDetails.csv', 'a+') as csvFile:
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                df = pd.read_csv("WorkersDetails\WorkersDetails.csv")
                cam = cv2.VideoCapture(0)
                ...
                root.configure(background='snow')
                cs = 'C:/Users/sriramatmakuri/Desktop/New folder (5)/Attendace_management_system-master/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"C:\Users\sriramatmakuri\Desktop\New folder (5)\Attendace_management_system-master\Attendance\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'sriram' :
            if password == 'sriram8':
                ...
                cs = 'C:/Users/sriramatmakuri/Desktop/New folder (5)/Attendace_management_system-master/WorkersDetails/WorkersDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
...
message = tk.Label(window, text="Intelligent-Attendance-Management-System", bg="cyan", fg="black", width=50,
...
lbl = tk.Label(window, text="Enter Enrollment", width=20, height=2, fg="black", bg="red", font=('times', 15, ' bold '))
...
lbl2 = tk.Label(window, text="Enter Name", width=20, fg="black", bg="red", height=2, font=('times', 15, ' bold '))
lbl2.place(x=200, y=300)

txt2 = tk.Entry(window, width=20, bg="yellow", fg="red", font=('times', 25, ' bold '))
txt2.place(x=550, y=310)

clearButton = tk.Button(window, text="Clear",command=clear,fg="black"  ,bg="red"  ,width=10  ,height=1 ,activebackground = "Red" ,font=('times', 15, ' bold '))
clearButton.place(x=950, y=210)

clearButton1 = tk.Button(window, text="Clear",command=clear1,fg="black"  ,bg="red"  ,width=10 ,height=1, activebackground = "Red" ,font=('times', 15, ' bold '))
clearButton1.place(x=950, y=310)

AP = tk.Button(window, text="Check Register ",command=admin_panel,fg="black"  ,bg="cyan"  ,width=19 ,height=1, activebackground = "Red" ,font=('times', 15, ' bold '))
